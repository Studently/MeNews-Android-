package com.example.ly.menews.view;
...
public class Item_view extends LinearLayout {
    ...
    public Item_view(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
       ...
       /* LayoutInflater mInflater = LayoutInflater.from(context);
        ...
        numView=findViewById(R.id.num_view);

        numView.setText(ta.getString(R.styleable.item_view_show_num));
